      ...
      <div className="max-w-md w-full mx-auto">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join MusicEdu and start your musical journey today
          </p>
        </div>
